...
import { Check, ChevronRight, Download, User, ArrowRight, ShieldCheck, Home, Fingerprint } from 'lucide-react';
...
const Register = () => {
  ...
  const [formData, setFormData] = useState({
    fullName: '', guardianName: '', dob: '', gender: '', mobile: '', altMobile: '', email: '',
    state: 'Madhya Pradesh', district: '', tehsil: '', village: '', panchayat: '', pinCode: '',
    landOwnership: 'Owned', khasraNo: '', totalArea: '', cultivatedArea: '', areaUnit: 'Acre',
    crop: '', cropVariety: '', season: 'Kharif', quantity: '', quantityUnit: 'Quintal', harvestDate: '', procYear: '2026-27',
    password: '', confirmPassword: '', declaration: false, terms: false
  });
        ...
        {aadhaarStep ? (
          ...
          <>
            ...
            <div className="bg-white gov-border shadow-sm overflow-hidden">
              {/* Header */}
          <div className="bg-govGreen-800 text-white px-6 py-4 border-b border-govSaffron-500">
            ...
            <form>
              ...
              {step === 3 && (
                <div className="space-y-8">
                  <div>
                    <h3 className="text-lg font-bold text-govGreen-800 border-b border-gray-200 pb-2 mb-4">Land Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label className="font-medium text-gray-700">I confirm that the information provided by me is correct. <span className="text-red-500">*</span></label>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label className="font-medium text-gray-700">I agree to the terms and conditions of the farmer procurement service. <span className="text-red-500">*</span></label>
